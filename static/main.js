...
function initStudentPage() {
    ...
    async function handleAttendanceSubmit(e) {
        ...
        try {
            // NEW: Use the simple, built-in canvas fingerprint generator
...
// ==============================================================================
function initControllerAndReportPage(){/*... Your original code ...*/}
function initEditAttendancePage(){/*... Your original code ...*/}
// NOTE: To save space, the code for the admin pages is not repeated, but it should remain in your file.
// The provided code above for these functions is correct and does not need to be changed.
...
function startStudentTimer(remainingTime, timerElement) { /*... Your original code ...*/ }
function showStatusMessage(message, type) { /*... Your original code ...*/ }
function haversineDistance(lat1, lon1, lat2, lon2) { /*... Your original code ...*/ }
function debounce(func, delay) { /*... Your original code ...*/ }

// NOTE: Please copy the full, unchanged functions from your last working main.js file
// into the sections marked /*... Your original code ...*/ to ensure all
// functionality on the admin pages remains. The student page is the only part that needed changes.